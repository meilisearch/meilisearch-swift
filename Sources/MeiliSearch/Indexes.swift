...
//    data: Data,
//    config: Config,
//    _ completion: (Result<Results<Index>, Swift.Error>) -> Void) {
//    do {
//      let rawIndexes: Results<Index> = try Constants.customJSONDecoder.decode(Results<Index>.self, from: data)
//
////      let rawIndexes: [Index] = try Constants.customJSONDecoder.decode([Index].self, from: data)
//      var indexes: [Index] = []
//      for rawIndex in rawIndexes.results {
